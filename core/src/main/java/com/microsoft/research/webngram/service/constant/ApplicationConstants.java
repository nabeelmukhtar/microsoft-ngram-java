...
public final class ApplicationConstants {
	...
	private static final Logger LOG = Logger
			.getLogger(ApplicationConstants.class.getCanonicalName());
	...
	static {
		try {
			applicationConstants.load(ApplicationConstants.class
					.getResourceAsStream(APP_CONSTANTS_FILE));
		} catch (IOException e) {
			LOG.log(Level.SEVERE,
					"An error occurred while loading properties.", e);
		}
	}

	/** The Constant CONTENT_ENCODING. */
	public static final String CONTENT_ENCODING = getProperty("com.microsoft.research.webngram.service.encoding");
	...
	public static final int CONNECT_TIMEOUT = getIntProperty("com.microsoft.research.webngram.service.connectTimeout");

	/** The Constant READ_TIMEOUT. */
	public static final int READ_TIMEOUT = getIntProperty("com.microsoft.research.webngram.service.readTimeout");
